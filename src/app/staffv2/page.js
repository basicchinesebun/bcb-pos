...
export default function StaffPage() {
  ...
  // iOS Safari keyboard: track keyboard height via visualViewport, pin chat thread above keyboard
  useEffect(() => {
      ...
      {tab === 'chat' && (
        <div className="flex-1 flex flex-col overflow-hidden">
          {!activeChatPhone ? (
            ...
            <div className="flex flex-col" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: chatKbH, zIndex: 30, background: 'var(--cream)' }}>
